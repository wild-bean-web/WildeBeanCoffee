...
const menuItems = [
  ...
  // Smoothies (Organic & Fresh)
  {
    ...
    allergens: ["Tree Nuts"],
    image: "/images/menu/Smoothies/GreenGlow.png",
    available: true,
    active: true,
  },
  {
    ...
    image: "/images/menu/Smoothies/BerryBoost.png",
    available: true,
    active: true,
  },
  {
    ...
    allergens: [],
    image: "/images/menu/Smoothies/TropicalBean.png",
    available: true,
    active: true,
  },
  {
    ...
    image: "/images/menu/Smoothies/NuttyBananaBliss.png",
    available: true,
    active: true,
  },
  {
    ...
    allergens: ["Dairy"],
    image: "/images/menu/Smoothies/EspressoEnergy.png",
    available: true,
    active: true,
  },
  // Oatmeals
