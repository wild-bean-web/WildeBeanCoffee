...
export const modifierGroups = [
  ...
  },
  {
    ...
    description:
      "Add syrup, puree, or sweetener. Price per pump is shown ($0.30 or $0.60).",
    type: "multiple",
    required: false,
    minSelections: 0,
    maxSelections: 6,
    options: [
      ...
      { name: "Blueberry puree pump", price: 0.6, available: true },
      ...
      { name: "Mango puree pump", price: 0.6, available: true },
      ...
      { name: "Strawberry Puree Pump", price: 0.6, available: true },
