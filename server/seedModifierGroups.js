...
export const modifierGroups = [
  ...
  },
  {
    ...
    description: "Add syrup, puree, or sweetener.",
    type: "multiple",
    required: false,
    minSelections: 0,
    maxSelections: 6,
    options: [
      ...
      { name: "Pistachio Syrup Pump", price: 0.5, available: true },
      { name: "Pump of Chai", price: 0.3, available: true },
  ...
  },
  {
    ...
    required: false,
    options: [
      { name: "Plain / White Cold Foam", price: 0.75, available: true },
      { name: "Matcha Cold Foam", price: 1.25, available: true },
      // Flavored options (shown in the Flavored Cold Foam dropdown)
      { name: "Banana Bread Cold Foam", price: 1, available: true },
      { name: "Blueberry Cold Foam", price: 1, available: true },
      { name: "Brown Sugar Cinnamon Cold Foam", price: 1, available: true },
      { name: "Caramel Cold Foam", price: 1, available: true },
      { name: "Chai Cold Foam", price: 1, available: true },
      { name: "Chocolate Cold Foam", price: 1, available: true },
      { name: "Cinnamon Bun Cold Foam", price: 1, available: true },
      { name: "Coconut Cold Foam", price: 1, available: true },
      { name: "Cookie Butter Cold Foam", price: 1, available: true },
      { name: "Hazelnut Cold Foam", price: 1, available: true },
      { name: "Honey Cold Foam", price: 1, available: true },
      { name: "Mango Cold Foam", price: 1, available: true },
      { name: "Pistachio Cold Foam", price: 1, available: true },
      { name: "Pumpkin Spice Cold Foam", price: 1, available: true },
      { name: "Strawberry Cold Foam", price: 1, available: true },
      { name: "Sugar-Free Vanilla Cold Foam", price: 1, available: true },
      { name: "Tiramisu Cold Foam", price: 1, available: true },
      { name: "Toasted Marshmallow Cold Foam", price: 1, available: true },
      { name: "Ube Cold Foam", price: 1, available: true },
      { name: "Vanilla Cold Foam", price: 1, available: true },
      { name: "White Chocolate Cold Foam", price: 1, available: true },
    ],
  },
  ...
  },
  {
    ...
    description: "Choose up to 8 dried toppings (optional)",
    type: "multiple",
    required: false,
    minSelections: 0,
    maxSelections: 8,
  ...
  {
    name: "Fruit Toppings (Build Your Own)",
    displayName: "Fruit Toppings",
    description: "Choose up to 2 fresh fruits (optional)",
    type: "multiple",
    required: false,
    minSelections: 0,
    maxSelections: 2,
