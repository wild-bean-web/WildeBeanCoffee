...
export const modifierGroups = [
  ...
  },
  {
    ...
    maxSelections: 6,
    options: [
      { name: "Amaretto Syrup Pump", price: 0.5, available: true },
      { name: "Apple Caramel Butter Syrup Pump", price: 0.5, available: true },
      ...
      { name: "Butter Pecan Syrup Pump", price: 0.5, available: true },
      { name: "Caramel Single Pump", price: 0.3, available: true },
      { name: "Chocolate Fudge Syrup Pump", price: 0.5, available: true },
      ...
      { name: "Elderflower Syrup Pump", price: 0.5, available: true },
      ...
      { name: "Lavender Syrup pump", price: 0.5, available: true },
      { name: "Lychee Syrup Pump", price: 0.5, available: true },
      { name: "Macadamia Syrup Pump", price: 0.5, available: true },
      { name: "Mango puree", price: 0.6, available: true },
      { name: "Passion Fruit Puree", price: 0.6, available: true },
