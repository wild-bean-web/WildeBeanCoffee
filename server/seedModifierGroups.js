...
export const modifierGroups = [
  ...
  },
  {
    ...
    displayName: "Syrups (+$0.75 each)",
    description: "Add flavored syrup. +$0.75 per pump.",
    type: "multiple",
    required: false,
    minSelections: 0,
    maxSelections: 5,
    options: [
      { name: "Vanilla Syrup Pump", price: 0.75, available: true },
      { name: "Caramel Syrup Pump", price: 0.75, available: true },
      { name: "Hazelnut Syrup Pump", price: 0.75, available: true },
      { name: "Strawberry Syrup Pump", price: 0.75, available: true },
      { name: "Coconut Syrup Pump", price: 0.75, available: true },
      { name: "Pumpkin Spice Syrup Pump", price: 0.75, available: true },
      { name: "Mocha Syrup Pump (Disabled)", price: 0.75, available: false },
      { name: "French Vanilla Syrup Pump (Disabled)", price: 0.75, available: false },
      { name: "Cinnamon Syrup Pump (Disabled)", price: 0.75, available: false },
      { name: "Seasonal Syrup Pump (Disabled)", price: 0.75, available: false },
    ],
  },
  {
